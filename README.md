...
In addition to the current repo, there is one more repository, [nd9991-c2-Infrastructure-as-Code-v1-Exercises_Solution](https://github.com/Bootcamp-AI/DevOps-Infrastructure-as-Code-Solution.git) that contains the solution to the exercises and video demos.  
